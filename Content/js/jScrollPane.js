function Setup_jScrollPane_Vertical_Slow(jScrollPane_ID) {
    ...
    try {
        ...
        if (Check_Element_Is_Not_Null(jScrollPane_ID)) {
            ...
            if ((jScrollPane_width > 20) && (jScrollPane_height > 20)) {
                ...
                $('#' + jScrollPane_ID).jScrollPane({ showArrows: false, animateScroll: true, animateDuration: 3000 });
                ...
                $('#' + jScrollPane_ID).find('div').each(function () {
                    ...
                    if ($(this).parent().parent().attr('id') == jScrollPane_ID) {
                        ...
                        if ($(this).attr('class') == 'jspPane') {
                            ...
                            $(this).width(jScrollPane_width - 0);
                            $(this).css('left', '');
                        }
                    }
    ...
    try {
        ...
        if ((jScrollPane_width > 20) && (jScrollPane_height > 20)) {
            ...
            if (api != null) {
                ...
                Setup_jScrollPane_Vertical_Slow(jScrollPane_ID);
                Hide_jScrollPane(jScrollPane_ID);
...
function Scroll_To_jScrollPane_Vertical_TOP(jScrollPane_ID) {
